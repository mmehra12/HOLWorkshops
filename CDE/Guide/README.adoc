...
link:#update-the-files[Update the files 7]
____

link:++#lab-1---walkthrough-of-cde-data-service++[*Lab 1 - Walkthrough of CDE Data Service 7*]

____
link:#accessing-the-virtual-cluster[ACCESSING THE VIRTUAL CLUSTER 11]

link:#step-1-select-the-appropriate-cde-service[Step 1 : Select the appropriate CDE Service 11]

link:#step-2-virtual-cluster-selection[Step 2 : Virtual cluster selection 11]
____

link:++#lab-2---create-and-trigger-ad-hoc-spark-jobs++[*Lab 2 - Create and trigger ad-hoc Spark jobs 13*]

____
link:#resource-creation[Resource Creation 13]

link:#job-creation[Job Creation 15]

link:#triggering-the-jobs[Triggering the jobs 19]
____

link:++#lab-3---add-schedule-to-the-ad-hoc-spark-jobs++[*Lab 3 - Add schedule to the ad-hoc Spark jobs 21*]

link:++#lab-4---orchestrate-a-set-of-jobs-using-airflow++[*Lab 4 - Orchestrate a set of jobs using Airflow 23*]

link:++#lab-5---install-and-configure-cde-cli++[*Lab 5 - Install and Configure CDE CLI 27*]

____
link:#for-mac-users[For Mac users: 27]

link:#for-windows-users[For Windows users: 31]
____

link:++#lab-6---run-jobs-using-cde-cli++[*Lab 6 - Run jobs using CDE CLI 34*]

____
link:#run-a-spark-scala-job-using-cli[Run a spark-scala job using CLI 34]
____

link:++#lab-7---data-lineage-and-auto-scaling++[*Lab 7 - Data Lineage and Auto-Scaling 35*]

____
link:#data-lineage-using-atlas[Data Lineage using Atlas 35]

link:#auto-scaling-in-cde[Auto-scaling in CDE 38]
____
...
____
_Note : If the page load takes a while, you can move to the next step, we can come back to this later_
____
...
_ +
_ Eg:- For apac01, job1 name would be *apac01_Lab3A_access_logs_ETL*
