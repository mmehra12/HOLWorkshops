...
* You can now continue from the STEP 3 in the 

image:media/media/image145.png[media/media/image145,width=271,height=174]
____
“link:#unlock-your-keytab-if-it-is-not-unlocked-already[*_[.underline]#Unlock your KeyTab if not unlocked already#_*]” section above
