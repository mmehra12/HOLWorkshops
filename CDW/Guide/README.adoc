...
) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' STORED AS TEXTFILE LOCATION 's3a://tworkshop-buk-d4c1b9a5/cdw/airlines-raw/airlines-csv/flights' tblproperties("skip.header.line.count" = "1");
----
...
) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' STORED AS TEXTFILE LOCATION 's3a://tworkshop-buk-d4c1b9a5/cdw/airlines-raw/airlines-csv/planes' tblproperties("skip.header.line.count" = "1");
...
CREATE EXTERNAL TABLE ${user_id}_airlines_raw.airports_csv(
  ...
  lon DOUBLE
) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' STORED AS TEXTFILE LOCATION 's3a://tworkshop-buk-d4c1b9a5/cdw/airlines-raw/airlines-csv/airports' tblproperties("skip.header.line.count" = "1");
----
